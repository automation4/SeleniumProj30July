package com.rahulshetty.pages.common;
...
public abstract class AbstractComponent {
    ...
    public void scrolltoElementJS(WebElement element) throws InterruptedException {
    ...
    public void moveToElementAC(WebElement element) {
       Actions action = new Actions(driver);
       action.moveToElement(element).build().perform();
         }

    public void scrollToElementAC(WebElement element) {
        Actions action = new Actions(driver);
